...
public class DetalhesChamadoViewModel
{
    ...
    public DetalhesChamadoViewModel(int id, string titulo, string descricao, DateTime dataAbertura, string nomeEquipamentoNome)
    {
        Id = id;
        Titulo = titulo;
        Descricao = descricao;
        DataAbertura = dataAbertura;
        NomeEquipamento = nomeEquipamentoNome;
    }
}
